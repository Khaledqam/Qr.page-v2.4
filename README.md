...
- **Direct Hash Navigation** — فتح قسم الفروع مباشرة عبر رابط مثل `qr.atoz.ps/#branches` أو `qr.atoz.ps/?branch` (الرابط يوجه تلقائياً لقسم الفروع)
- **Smooth Transitions** — تأثير انتقال سلس (0.28 ثانية) عند التبديل بين الأقسام
- **Panel Auto-Hide on Load** — جميع الأقسام مخفية افتراضياً عند التحميل، ثم يظهر فقط القسم المطلوب حسب الرابط (يمنع عرض كل المحتوى دفعة واحدة)
- **Branch Cards** — بطاقة لكل فرع مع زر الخريطة + واتساب + زيارة مباشرة (مشروط بوجود البيانات)
...
- **Multi-User RBAC** — إنشاء مستخدمين بأدوار مختلفة (superadmin, admin, editor, viewer)
- **Approval Queue** — تعديلات المحررين تنتظر موافقة المدير
- **Remember Me** — تسجيل دخول آمن لمدة 30 يوم
- **Password Eye Toggle** — عرض/إخفاء كلمة المرور في لوحة التحكم
- **Tracking Scripts** — حقن Google Analytics / Meta Pixel / Tawk.to في head أو body
- **Branch Drag & Drop** — ترتيب الفروع بالسحب والإفلات
- **Footer / Tagline Controls** — تحكم كامل في نصوص الترويسة والتذييل
- **Scroll Behavior** — تمرير سلس تلقائي مع `scroll-margin-top` للتعويض عن الهيدر
- **Advanced Color Pickers** — واجهة ألوان متطورة: منتقي لوني مرئي + حقل نصي يعرض كود HEX قابل للتعديل المباشر (بدلاً من أرقام RGBA)
- **HEX Display Mode** — عرض ألوان HEX بدلاً من RGBA في حقول النصوص، مع تحويل تلقائي ذكي عند الإدخال
- **Color Picker Sync** — مزامنة فورية بين منتقي الألوان والحقل النصي: عند اختيار لون يظهر كود HEX مباشرة
- **Link Copy Button** — زر نسخ الرابط في كل بطاقة (قابل للتفعيل/التعطيل من اللوحة)
- **Branch Password Protection** — حماية الفروع بكلمة مرور مع مؤشر قفل 🔒 يظهر على البطاقة
- **Branch Direct Link** — زر "زيارة" مباشر للفروع التي تحتوي على رابط مباشر
- **WYSIWYG Bio Editor** — محرر نصوص مرئي للتعريف بالمتجر (bio_html)
- **Card Shape Options** — خيارات متعددة لأشكال البطاقات: زجاجي، زجاج فضائي Spatial Glass UI، مرتفع بظل، بإطار فقط، مسطح
- **Appearance Live Preview** — معاينة فورية للتغييرات في المظهر قبل الحفظ
- **Custom Icon Upload** — رفع أيقونات مخصصة للروابط بدلاً من الأيقونات التلقائية
- **Icon Source Selection** — اختيار مصدر الأيقونة: تلقائي حسب النوع، أيقونة المنصة الأصلية، أو أيقونة مرفوعة يدوياً
- **Card Border/Background/Text Colors** — تحكم منفصل ودقيق في ألوان البطاقات (خلفية، حدود، نص)
- **Branch Colors Control** — تحكم كامل في ألوان بطاقات الفروع (خلفية، حدود، اسم الفرع، نص التفاصيل، خلفية التفاصيل)
- **Header/Footer Color Sections** — أقسام ألوان منفصلة للهيدر والفوتر مع معاينة حية
