...
<div class="admin" id="adminShell">
  ...
  <nav class="admin__tabs" role="tablist">
    ...
    <button class="admin__tab"                    role="tab" data-tab="profile"        aria-selected="false" id="profileTab">حسابي</button>
  ...
  <section class="admin__panel" data-panel="appearance" role="tabpanel" hidden>
    ...
    <h3 class="admin__section-title">الألوان الأساسية</h3>
    ...
    <h3 class="admin__section-title">ألوان الهيدر (الرأس)</h3>
    <div class="appearance-grid">
      <div class="appearance-field">
        <label class="admin__label" for="headerBgInput">خلفية الهيدر</label>
        <div class="color-input-wrapper">
          <input type="color" id="headerBgPicker" class="color-picker-hidden" value="#0c1727">
          <input type="text" id="headerBgInput" class="admin__input color-text-input" value="rgba(12,23,39,0.7)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="headerTextInput">نص الهيدر</label>
        <div class="color-input-wrapper">
          <input type="color" id="headerTextPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="headerTextInput" class="admin__input color-text-input" value="rgba(255,255,255,0.95)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="headerTaglineInput">النص الثانوي للهيدر</label>
        <div class="color-input-wrapper">
          <input type="color" id="headerTaglinePicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="headerTaglineInput" class="admin__input color-text-input" value="rgba(255,255,255,0.6)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
    </div>

    <h3 class="admin__section-title">ألوان الفوتر (التذييل)</h3>
    <div class="appearance-grid">
      <div class="appearance-field">
        <label class="admin__label" for="footerBgInput">خلفية الفوتر</label>
        <div class="color-input-wrapper">
          <input type="color" id="footerBgPicker" class="color-picker-hidden" value="#0c1727">
          <input type="text" id="footerBgInput" class="admin__input color-text-input" value="rgba(12,23,39,0.85)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="footerTextInput">نص الفوتر</label>
        <div class="color-input-wrapper">
          <input type="color" id="footerTextPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="footerTextInput" class="admin__input color-text-input" value="rgba(255,255,255,0.6)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="footerBorderInput">حد الفوتر</label>
        <div class="color-input-wrapper">
          <input type="color" id="footerBorderPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="footerBorderInput" class="admin__input color-text-input" value="rgba(255,255,255,0.08)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
    </div>

    <h3 class="admin__section-title">ألوان بطاقات الروابط</h3>
    <div class="appearance-grid">
      <div class="appearance-field">
        <label class="admin__label" for="cardBgInput">خلفية البطاقة</label>
        <div class="color-input-wrapper">
          <input type="color" id="cardBgPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="cardBgInput" class="admin__input color-text-input" value="rgba(255,255,255,0.07)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="cardBorderInput">حد البطاقة</label>
        <div class="color-input-wrapper">
          <input type="color" id="cardBorderPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="cardBorderInput" class="admin__input color-text-input" value="rgba(255,255,255,0.12)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="cardTextInput">نص البطاقة</label>
        <div class="color-input-wrapper">
          <input type="color" id="cardTextPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="cardTextInput" class="admin__input color-text-input" value="rgba(255,255,255,0.92)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
    </div>

    <h3 class="admin__section-title">ألوان بطاقات الفروع</h3>
    <div class="appearance-grid">
      <div class="appearance-field">
        <label class="admin__label" for="branchBgInput">خلفية الفرع</label>
        <div class="color-input-wrapper">
          <input type="color" id="branchBgPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="branchBgInput" class="admin__input color-text-input" value="rgba(255,255,255,0.07)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="branchBorderInput">حد الفرع</label>
        <div class="color-input-wrapper">
          <input type="color" id="branchBorderPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="branchBorderInput" class="admin__input color-text-input" value="rgba(255,255,255,0.12)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="branchNameInput">اسم الفرع</label>
        <div class="color-input-wrapper">
          <input type="color" id="branchNamePicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="branchNameInput" class="admin__input color-text-input" value="#ffffff" placeholder="#... أو rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="branchTextInput">نص تفاصيل الفرع</label>
        <div class="color-input-wrapper">
          <input type="color" id="branchTextPicker" class="color-picker-hidden" value="#ffffff">
          <input type="text" id="branchTextInput" class="admin__input color-text-input" value="rgba(255,255,255,0.6)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
      <div class="appearance-field">
        <label class="admin__label" for="branchDetailsBgInput">خلفية التفاصيل</label>
        <div class="color-input-wrapper">
          <input type="color" id="branchDetailsBgPicker" class="color-picker-hidden" value="#000000">
          <input type="text" id="branchDetailsBgInput" class="admin__input color-text-input" value="rgba(0,0,0,0.3)" placeholder="rgba(...)" dir="ltr">
        </div>
      </div>
    </div>
    ...
    <select id="cardStyleSelect" class="admin__input">
      ...
      <option value="spatial-glass">زجاج فضائي (Spatial Glass UI)</option>
    ...
    <div id="appearancePreview" class="appearance-preview">
      <div class="appearance-preview__card">
        ...
        <span>مثال رابط - Spatial Glass UI</span>
      </div>
    </div>
    ...
    <div class="form-grid">
      ...
      <div>
        ...
        <div class="password-input-wrap">
          ...
          <button class="password-toggle" type="button" aria-label="إظهار/إخفاء كلمة المرور">
  ...
  <section class="admin__panel" data-panel="import-export" role="tabpanel" hidden>
    ...
    <h3 class="admin__section-title">أدوات الصيانة</h3>
    <p>مسح كاش المتصفح لإجبار إعادة تحميل جميع الموارد (CSS, JS, Images).</p>
    <button id="clearCacheBtn" class="btn btn--danger">🗑️ مسح كاش المتصفح وإعادة التحميل</button>
    <p class="admin__status" id="clearCacheStatus"></p>
  </section>

  <!-- ---- PROFILE TAB (My Account) ---- -->
  <section class="admin__panel" data-panel="profile" role="tabpanel" hidden>
    <h3 class="admin__section-title">بيانات الحساب</h3>
    <div class="form-grid">
      <div>
        <label class="admin__label" for="profileUsername">اسم المستخدم</label>
        <input class="admin__input" id="profileUsername" type="text" readonly disabled>
        <p class="admin__hint" style="margin-top:4px">لا يمكن تعديل اسم المستخدم</p>
      </div>
      <div>
        <label class="admin__label" for="profileDisplayName">الاسم الظاهر</label>
        <input class="admin__input" id="profileDisplayName" type="text" placeholder="مثال: محمد أحمد">
      </div>
    </div>
    <button id="updateProfileBtn" class="btn btn--primary">حفظ التغييرات</button>
    ...
    <div class="form-grid">
      <div>
        ...
        <div class="password-input-wrap">
          <input class="admin__input" id="currentPassword" type="password" dir="ltr">
          <button class="password-toggle" type="button" aria-label="إظهار/إخفاء كلمة المرور">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
          </button>
        </div>
      ...
      <div></div>
      <div>
        <label class="admin__label" for="newPasswordProfile">كلمة المرور الجديدة</label>
        <div class="password-input-wrap">
          <input class="admin__input" id="newPasswordProfile" type="password" dir="ltr" minlength="8">
          <button class="password-toggle" type="button" aria-label="إظهار/إخفاء كلمة المرور">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
          </button>
        </div>
      ...
      <div>
        <label class="admin__label" for="confirmPasswordProfile">تأكيد كلمة المرور</label>
        <div class="password-input-wrap">
          <input class="admin__input" id="confirmPasswordProfile" type="password" dir="ltr" minlength="8">
          <button class="password-toggle" type="button" aria-label="إظهار/إخفاء كلمة المرور">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
          </button>
        </div>
    ...
    <button id="changePasswordBtn" class="btn btn--primary">تغيير كلمة المرور</button>
    <p class="admin__status" id="passwordStatus"></p>
  </section>

</div><!-- .admin -->
<?php endif; ?>

<script src="/admin/admin.js?v=4"></script>
</body>
</html>
